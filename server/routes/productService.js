...
// controller
const { create, list, remove, read, update, listBy, searchFilters } = require('../controllers/productService');
...
router.get('/product-service/:count', list);
/**
 * @swagger
 * /api/product/{count}:
 *   get:
...
router.get("/product-service/:id", read);
/**
 * @swagger
 * /api/products/{id}:
 *   get:
...
// สร้างสินค้าใหม่
router.post('/product-service', auth, adminCheck, create);
/**
 * @swagger
 * /api/products:
 *   post:
...
// ลบสินค้า
router.delete('/product-service/:id', auth, adminCheck, remove);
/**
 * @swagger
 * /api/product/{id}:
 *   delete:
...
// อัพเดทสินค้า
router.put("/product-service/:id", auth, adminCheck, update);
/**
 * @swagger
 * /api/product/{id}:
 *   put:
...
router.post("/productby-service", listBy);
/**
 * @swagger
 * /api/productby:
 *   post:
...
router.post('/search-product-service/filters', searchFilters);
/**
 * @swagger
 * /api/search/filters:
 *   post:
